...
- **Héroe** (`index.html`): pérgola bioclimática con lamas que se abren y
  cierran en onda, giro automático, orbit al arrastrar.
...
- Acotaciones en cobre alrededor del modelo (lenguaje de plano).
